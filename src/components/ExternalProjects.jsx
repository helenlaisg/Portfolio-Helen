...
const academicResearchProjects = [
  {
    id: 1,
    role: 'Pesquisadora – Projeto Catalisa ICT (Bolsista)',
    project: 'Interoperabilidade de Dados Médicos com Blockchain',
    description: [
      'Pesquisa e desenvolvimento de soluções para interoperabilidade de dados médicos usando blockchain.',
      'Estudo de rastreabilidade, integridade e segurança de informações clínicas.',
      'Desenvolvimento de plataforma para compartilhamento seguro entre sistemas de saúde.'
    ],
    details:
      'Desenvolvimento de uma plataforma baseada em tecnologia blockchain para assegurar a interoperabilidade, rastreabilidade e integridade de dados médicos entre diferentes sistemas de saúde. O projeto visa criar um ambiente seguro e padronizado para o compartilhamento de informações clínicas, reduzindo redundâncias, ampliando a confiabilidade e garantindo conformidade com requisitos de privacidade e segurança.',
    status: 'Em andamento',
...
const externalProjects = [
  {
    ...
    description: [
      ...
      'Implementação de lógica de bloqueio e desbloqueio automático de chamados/setores,como também painéis de controle para bloqueio e desbloqueio de setores/chamados em casos específicos.',
      'Implementação de Relatórios e exportações de dados para PDF e Excel.'
    ],
        ...
        <div className="container" style={{ maxWidth: '1400px' }}>
          ...
          >
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', textAlign: 'center' }}>
              Projetos de Pesquisa <span className="text-gradient">Acadêmica</span>
            </h2>
            <p style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto 3rem auto', color: 'var(--color-text-muted)' }}>
              Projetos acadêmicos e de pesquisa com foco em inovação, segurança e interoperabilidade.
            </p>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
              {academicResearchProjects.map((project, index) => (
                <motion.div
                  key={project.id}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                    <div style={{ background: 'rgba(0, 191, 255, 0.1)', padding: '10px', borderRadius: '50%', color: 'var(--color-primary)' }}>
                      {project.icon}
                    </div>
                    <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.8rem', color: 'var(--color-text-muted)', border: '1px solid var(--color-border)', padding: '4px 8px', borderRadius: '20px' }}>
                  ...
                  <h3 style={{ fontSize: '1.5rem', marginBottom: '0.6rem', color: 'var(--color-heading)' }}>{project.role}</h3>

                  <p style={{ color: 'var(--color-primary)', fontSize: '0.95rem', marginBottom: '1rem', fontWeight: '600' }}>
                    {project.project}
                  </p>
